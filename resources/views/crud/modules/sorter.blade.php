...
<a class="col_sort text-secondary lead asc" href="{{ CrudController::getRoutePrefixed("$tableName.index", array_merge($sortParams, ['sort_way' => 'asc'])) }}">&nbsp;&darr;&nbsp;</a>
@endif
...
<a class="col_sort text-secondary lead desc" href="{{ CrudController::getRoutePrefixed("$tableName.index", array_merge($sortParams, ['sort_way' => 'desc'])) }}">&nbsp;&uarr;&nbsp;</a>
@endif
